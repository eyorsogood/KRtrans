...
if ( ! function_exists( 'qed_init_theme_assets' ) ) {
	...
	function qed_init_theme_assets() {
		...
		if ( THEME_IS_DEV_MODE ) {
			...
			wp_enqueue_style( 'datepicker', PARENT_URL . '/assets/datepicker/css/bootstrap-datepicker.min.css', array(), '' );
			...
			wp_enqueue_script( 'datepicker', PARENT_URL . '/assets/datepicker/js/bootstrap-datepicker.min.js',array( 'jquery' ), '',true );
