		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="footer__copyright"><?php echo qed_esc_text( qed_get_option( 'footer_text_note', 'option', 'Development and Design by <a href="https://eyorsogood.com" target="_blank">Rouie Ilustrisimo</a>' ), 'option_input', true ); ?></div>
				</div>
			</div>
		</div>
	</div>
